...
async function Paintings() {
  const data = await getAllProjects("painting");
    ...
    return (
      <div>
        <div className="flex h-dvh flex-col">
          <h2 className="py-10 text-center text-2xl">Paintings</h2>
          <h2 className="py-10 text-left text-xl uppercase">
            There are no paintings in your database
          </h2>
          <Link
            href="/dashboard/paintings/add"
