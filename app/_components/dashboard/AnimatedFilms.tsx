...
async function AnimatedFilms() {
  const data = await getAllProjects("animated film");
    ...
    return (
      <div>
        <div className="flex h-dvh flex-col">
          <h2 className="py-10 text-center text-2xl">My animated films</h2>
          <h2 className="py-10 text-left text-xl uppercase">
            There are no animated film in your database
          </h2>
          <Link
            href="/dashboard/animatedfilms/add"
